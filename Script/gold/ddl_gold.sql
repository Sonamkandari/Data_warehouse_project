...
Script Purpose:
       ...
       Tthe Gold layer represents the final dimension and the fact tables (star schema).

        Each view performs transformations and combines data from the Silver layer to
        produce a clean, enriched, and business-ready data set. 

        usage:
        these views can be queried directly for analytical and reporting. 
