...
- Note : we use stored procedures so that we dont have to run the scripts of all the table oe by one with the help of stored procedure we can exxcecute them all together
