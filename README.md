...
- By using the Notion, we will create the main phases and stages of the project.
 ...
 - **Objective** The objective of the project is to develop a modern data warehouse using SQL Server to consolidate sales data, enabling analytical reports and informed decision making.
